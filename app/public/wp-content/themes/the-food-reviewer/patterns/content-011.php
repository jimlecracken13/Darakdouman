...
/**
 * Title: Content 011
 * Slug: the-food-reviewer/content-011
 * Categories: teams
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-contrast-color has-text-color has-superbfont-xlarge-font-size" style="font-style:normal;font-weight:300">Get all the best tips for food<br> around the world.</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-left has-contrast-color has-text-color has-superbfont-medium-font-size">Food & Travel</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-left has-contrast-color has-text-color" style="font-size:24px">Secret Restaurants</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":3,"textColor":"contrast","fontSize":"superbfont-medium"} -->
<h3 class="wp-block-heading has-text-align-left has-contrast-color has-text-color has-superbfont-medium-font-size">The Best Wine Pairing</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
